...
> Be patient! In ~3 mins your app is live, at your [app url](https://container--tkways.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container--tkways.containers.anotherwebservice.com/
...
```
git clone git@github.com:nanimousee/container--tkways.git
cd container--tkways
```
...
```
docker attach container--tkways
```
